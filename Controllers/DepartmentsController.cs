...
namespace JediAcademy.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(JediAcademyContext context)
        {
            _context = context;
        }
        ...
        {
            var jediAcademyContext = _context.Departments.Include(d => d.Administrator);
            return View(await jediAcademyContext.ToListAsync());
        }
